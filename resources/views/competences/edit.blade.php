...
<div class="max-w-2xl mx-auto">
    <div class="flex items-center mb-6">
        ...
        <h1 class="text-2xl font-bold text-gray-800">Modifier la compétence</h1>
    </div>

    <div class="bg-white rounded-lg shadow p-6">
        <form action="{{ route('web.competences.update', $competence->code_comp) }}" method="POST" class="space-y-5">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                >{{ old('description_comp', $competence->description_comp) }}</textarea>
