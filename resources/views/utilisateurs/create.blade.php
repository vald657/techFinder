...
<div class="max-w-2xl mx-auto">
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <form action="{{ route('web.utilisateurs.store') }}" method="POST" class="space-y-5">
            @csrf
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <input type="text" id="nom_user" name="nom_user" value="{{ old('nom_user') }}" required
                ...
                <div>
                    ...
                    <input type="text" id="prenom_user" name="prenom_user" value="{{ old('prenom_user') }}" required
                           class="w-full px-3 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500
            ...
            <div>
                ...
                <input type="text" id="login_user" name="login_user" value="{{ old('login_user') }}" required
                       class="w-full px-3 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500
            ...
            <div>
                ...
                <input type="password" id="password_user_confirmation" name="password_user_confirmation" required
            ...
            <div>
                ...
                <input type="text" id="tel_user" name="tel_user" value="{{ old('tel_user') }}"
                       class="w-full px-3 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-5">
                ...
                <div>
                    ...
                    <select id="sexe_user" name="sexe_user" required
                        ...
                        <option value="M" {{ old('sexe_user') === 'M' ? 'selected' : '' }}>Masculin</option>
                        <option value="F" {{ old('sexe_user') === 'F' ? 'selected' : '' }}>Féminin</option>
                    </select>
                ...
                <div>
                    ...
                    <select id="etat_user" name="etat_user" required
                        ...
                        <option value="bloquer" {{ old('etat_user') === 'bloquer' ? 'selected' : '' }}>Bloqué</option>
                    </select>
